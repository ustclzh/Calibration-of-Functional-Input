...
sigma_e=0.02;
iso=1;
pre_KL9=preparition_for_general_data(sigma_e,M,1,iso);
M=12;
pre_KL12=preparition_for_general_data(sigma_e,M,1,iso);
M=15;
pre_KL15=preparition_for_general_data(sigma_e,M,1,iso);
M=3;
pre_KL3=preparition_for_general_data(sigma_e,M,1,iso);
%filename=['pre391215basis'];
%save(filename,'-v7.3')
data1.M=50;
