...
% Warning: all unit of length variable in this simulation is meter (instead of
% km). e.g. the unit for x, y are m;
...
specifyCoefficients(model,'m',0,'d',S,'c',c,'a',0,'f',@fsource);
